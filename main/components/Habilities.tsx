...
import Cadastros from "../assets/criacao-de-usuario.jpeg";
    ...
    <>
      <motion.div className="w-screen h-auto flex flex-col justify-center items-center">
        <div className="w-full flex flex-col justify-center items-center mb-20">
          ...
          <h2 className="mb-20 text-4xl font-bold underline decoration-orange-600">
            Projetos
          </h2>
          <div className="w-4/6 flex items-center justify-between">
            <div className="w-15 h-auto p-3 gap-5 rounded-md bg-zinc-800 flex flex-col items-center justify-between hover:scale-110 transition-all ease-in-out">
              ...
              <Link
                className="uppercase font-bold bg-[#111111] p-3 rounded-full flex items-center gap-2"
